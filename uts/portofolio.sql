...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Nov 2020 pada 13.43
...
INSERT INTO `biodata` (`id_biodata`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `alamat`, `agama`, `kewarganegaraan`) VALUES
(1, 'Ananda Arya Pratama', 'Jakarta', '08 Juli 2000', 'Laki - Laki', 'Villa Mutiara Serpong', 'Islam', 'Indonesia');
...
CREATE TABLE `pengalaman` (
  ...
  `nama_kerja` varchar(20) NOT NULL,
...
(1, 1, 'pizzahut.jpg', 'Magang Pizza Hut', 'July 2019 - September 2019', 'Bekerja di sebuah restoran Pizza Hut Alam Sutera sebagai Server', 'forka.jpg', 'Forka Fest 2019', 'Menjadi Panitia dalam acara Forka Fest 2019 sebagai Panitia Perlengkapan');
...
--
ALTER TABLE `pengalaman`
  MODIFY `id_pengalaman` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
